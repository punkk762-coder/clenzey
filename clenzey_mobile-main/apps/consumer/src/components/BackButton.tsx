...
/** Default size used by floating overlays. */
...
/** @deprecated use variant-specific surface from BackButtonSurface */
export const backButtonSurfaceStyle = {
  width: BACK_BUTTON_FLOATING_SIZE,
  height: BACK_BUTTON_FLOATING_SIZE,
  borderRadius: BACK_BUTTON_FLOATING_SIZE / 2,
  backgroundColor: colors.white,
