/**
 * Validation utilities for the Partner app.
...
/**
 * Validates the partner signup form fields.
 */
export function validateSignupForm(form: PartnerSignupForm): ValidationResult {
  const errors: Record<string, string> = {};
